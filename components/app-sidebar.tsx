...
const navItems: NavItem[] = [
  ...
  { title: "Referrals",     href: "/referrals",     icon: ClipboardList,   module: "referrals" },
  { title: "Patients",      href: "/patients",      icon: Users,           module: "patients" },
  { title: "Hospitals",     href: "/hospitals",     icon: Hospital,        module: "hospitals" },
  { title: "Bed Capacity",  href: "/bed-capacity",  icon: BedDouble,       module: "bed-capacity" },
  { title: "Specialists",   href: "/specialists",   icon: Stethoscope,     module: "specialists" },
...
export function AppSidebar() {
  ...
  const filteredNavItems = navItems.filter(
    (item) => accessibleModules.includes("all") || accessibleModules.includes(item.module)
  )
    ...
    <div className="flex h-full w-64 flex-col border-r bg-card">
      ...
      <div className="flex h-16 items-center gap-2 border-b px-6">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-xs text-muted-foreground leading-none mt-1">Referral System</span>
        </div>
      </div>
